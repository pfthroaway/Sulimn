...
namespace Sulimn
{
    ...
    internal class FeetArmor : Item, IEquatable<FeetArmor>, INotifyPropertyChanged
    {
        ...
        private static bool Equals(FeetArmor left, FeetArmor right)
        {
        ...
        internal FeetArmor(string name, ItemTypes itemType, string description, int defense, int weight, int value,
