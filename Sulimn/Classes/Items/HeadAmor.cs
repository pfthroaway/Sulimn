...
namespace Sulimn
{
    ...
    internal class HeadArmor : Item, IEquatable<HeadArmor>, INotifyPropertyChanged
    {
        ...
        private static bool Equals(HeadArmor left, HeadArmor right)
        {
        ...
        internal HeadArmor(string name, ItemTypes itemType, string description, int defense, int weight, int value,
