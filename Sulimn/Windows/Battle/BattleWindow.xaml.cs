...
namespace Sulimn.Windows.Battle
{
    ...
    public partial class BattleWindow : INotifyPropertyChanged
    {
        ...
        internal Exploration.ExploreWindow RefToExploreWindow { get; set; }

        internal Exploration.FieldsWindow RefToFieldsWindow { private get; set; }

        internal Exploration.ForestWindow RefToForestWindow { private get; set; }

        internal Exploration.CathedralWindow RefToCathedralWindow { private get; set; }

        internal Exploration.MinesWindow RefToMinesWindow { private get; set; }

        internal Exploration.CatacombsWindow RefToCatacombsWindow { private get; set; }
        ...
        {
            Characters.CharacterWindow characterWindow = new Characters.CharacterWindow { RefToBattleWindow = this };
        ...
        {
            Characters.CastSpellWindow castSpellWindow = new Characters.CastSpellWindow { RefToBattleWindow = this };
