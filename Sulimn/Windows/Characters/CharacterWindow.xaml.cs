...
namespace Sulimn.Windows.Characters
{
    ...
    public partial class CharacterWindow : INotifyPropertyChanged
    {
        ...
        internal Shopping.TheTavernBarWindow RefToTheTavernBarWindow { private get; set; }
        internal Shopping.TheArmouryWindow RefToTheArmouryWindow { private get; set; }
        internal Shopping.MagickShoppeWindow RefToMagickShoppeWindow { private get; set; }
        internal Shopping.SilverEmpireWindow RefToSilverEmpireWindow { private get; set; }
        internal Shopping.WeaponsRUsWindow RefToWeaponsRUsWindow { private get; set; }
        internal Shopping.TheGeneralStoreWindow RefToTheGeneralStoreWindow { private get; set; }
